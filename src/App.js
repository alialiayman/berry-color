        ...
        names={[
          {
            ...
            palette: [
              ...
              { name: "English Walnut", hsl: "9,28%,19%" },
              { name: "Tomato", hsl: "9,100%,64%" },
              { name: "Firebrick, Thunderbird", hsl: "0,68%,42%" },
              { name: "Lavender blush", hsl: "340,100%,97%" },
          ...
          },
          {
            ...
            palette: [
              ...
              { name: "Pumpkin orange/Ecstasy", hsl: "28,92%,53%" },
